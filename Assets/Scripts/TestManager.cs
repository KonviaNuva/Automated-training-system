...
public class TestManager : MonoBehaviour
{
    ...
    Question[][] allQuestions = new Question[][]
    {
        ...
        new Question[]
        {
            ...
            "необходимы места массового пребывания", false,
        ...
        new Question[]
        {
            ...
            "прекрастить контакт с отравляющими веществами", true,
